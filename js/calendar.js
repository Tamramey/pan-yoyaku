const LESSONS = {
  ...
  "2026-07-26": { menu: "食パン",         seats: 0 },   /* 満席の例 */
  ...
  "2026-08-11": { menu: "クロワッサン",   seats: 0 },   /* 満席の例 */
...
function makeLessonTag(key, lesson, month, day){
  ...
  if(lesson.seats <= 0){
    ...
    /* クリックで選択(ステップ1では仮のダイアログ表示まで) */
    tag.addEventListener("click", function(){
      alert(
        month + "月" + day + "日の「" + lesson.menu + "」レッスンを選択しました。\n" +
        "(残" + lesson.seats + "席)\n\n" +
        "※ステップ2で、ここから予約フォームに進むようになります。"
      );
    });
  }
  return tag;
